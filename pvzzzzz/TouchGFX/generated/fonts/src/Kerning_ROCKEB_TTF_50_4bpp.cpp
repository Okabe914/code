...
KEEP extern const touchgfx::KerningNode kerning_ROCKEB_TTF_50_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x0046, -6 },  // (First char = [0x0046, F], Second char = [0x0065, e], Kerning dist = -6)
    ...
    { 0x0046, -6 },  // (First char = [0x0046, F], Second char = [0x006F, o], Kerning dist = -6)
    ...
    { 0x006D, -1 },  // (First char = [0x006D, m], Second char = [0x0075, u], Kerning dist = -1)
    { 0x0072,  2 },  // (First char = [0x0072, r], Second char = [0x0075, u], Kerning dist = 2)
